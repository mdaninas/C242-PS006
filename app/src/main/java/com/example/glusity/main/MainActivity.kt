...
import com.example.glusity.databinding.ActivityMainBinding
import com.example.glusity.di.Injection
...
class MainActivity : AppCompatActivity() {
    ...
    private val mainViewModel: MainViewModel by viewModels {
        MainViewModelFactory(Injection.provideRepository(this))
    }
